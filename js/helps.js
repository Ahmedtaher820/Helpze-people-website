...
//navbarDropdown.onmousemove = function(){
//    "use strict";
//    document.querySelector(".dropdown-menu").style.display = "block"
//}
//navbarDropdown.onmouseout = function(){
//    "use strict";
...
var head = document.querySelector(".head"),
    ...
    p2 = "Sed tincidunt, magna ut vehicula volutpat, turpis diam condimentum justo, posuere congue turpis massa in mi. Proin ornare at massa at fermentum. Nunc aliquet sed nisi iaculis ornare. Nam semper tortor eget est egestas, eu sagittis nunc sodales. Interdum et malesuada fames ac ante ipsum primis in faucibus. Praesent bibendum sapien sed purus molestie malesuada. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
    p3 = "Aliquam dolor odio, mollis sed feugiat sit amet, feugiat ut sapien. Nunc eu dignissim lorem. Suspendisse at hendrerit enim. Interdum et malesuada fames ac ante ipsum primis in faucibus. Sed condimentum semper turpis vel facilisis. Nunc vel faucibus orci. Mauris ut mauris rhoncus, efficitur nisi at, venenatis quam. Praesent egestas pretium enim sit amet finibus. Curabitur at erat molestie, tincidunt lorem eget, consequat ligula.";
...
for(var i=0 ; i<btn.length ; i++){
    btn[i].addEventListener("click",function(){
        ...
        currentActive[0].className = currentActive[0].className.replace("dolar","");
...
//for(var x = 0 ; i<dots.length ; x++){
//    var dotsInterval = setInterval(function(){
//    var currentDots = document.getElementsByClassName("active-dot");        
//    currentDots[0].className.replace("active-dot","");
//    dots[x].className += "active-dot"
//    }
//    ,2000)
//}
